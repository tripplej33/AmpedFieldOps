...
// Get default permissions for a role (shared with auth.ts)
function getDefaultPermissions(role: string): string[] {
  const basePermissions = ['can_create_timesheets', 'can_view_own_timesheets', 'can_edit_own_timesheets', 'can_delete_own_timesheets', 'can_view_projects', 'can_view_clients', 'can_view_dashboard'];
